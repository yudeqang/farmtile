...
_default_js = [
            ('leaflet',
                     'https://imgs.shuxitech.com/leaflet.js'),
                ('jquery',
                         'https://imgs.shuxitech.com/jquery-1.12.4.min.js'),
                    ('bootstrap',
                             'https://imgs.shuxitech.com/bootstrap.min.js'),
                        ('awesome_markers',
                                 'https://imgs.shuxitech.com/leaflet.awesome-markers.js'),  # noqa
                            ]


_default_css = [
            ('leaflet_css',
                     'https://imgs.shuxitech.com/leaflet.css'),
                ('bootstrap_css',
                         'https://imgs.shuxitech.com/bootstrap.min.css'),
                    ('bootstrap_theme_css',
                             'https://imgs.shuxitech.com/bootstrap-theme.min.css'),  # noqa
                        ('awesome_markers_font_css',
                                 'https://imgs.shuxitech.com/font-awesome.min.css'),  # noqa
                            ('awesome_markers_css',
                                     'https://imgs.shuxitech.com/leaflet.awesome-markers.css'),  # noqa
                                ('awesome_rotate_css',
                                         'https://imgs.shuxitech.com/leaflet.awesome.rotate.css'),  # noqa
                                    ]
